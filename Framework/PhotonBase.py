...
class Hyperpipe(BaseEstimator):
    ...
    def fit(self, data, targets, **fit_params):
        ...
        :param data: the training and test data, array-like, with shape = [N, D], where N is the number of samples and D is the number of features.
