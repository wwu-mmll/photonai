...
perm_tester = PermutationTest(create_hyperpipe, n_perms=20, n_processes=3, random_state=11, permutation_id='basic_svm_permutation_example')
perm_tester.fit(X, y)

# Load results
handler = ResultsTreeHandler()
handler.load_from_mongodb(mongodb_connect_url='mongodb://trap-umbriel:27017/photon_results', pipe_name='basic_svm_pipe_permutation_test')
