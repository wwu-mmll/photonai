...
my_pipe = Hyperpipe('basic_svm_pipe_no_test',
                    ...
                    inner_cv_callback_function=MinimumPerformance('accuracy', 0.96), # skips next folds of inner cv if accuracy in first fold is below 0.96
                    verbosity=1,
