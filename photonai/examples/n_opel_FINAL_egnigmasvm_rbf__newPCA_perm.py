...
# perm_tester._calculate_results(perm_tester.permutation_id, perm_tester.metrics, False)
result = perm_tester.get_permutation_status(perm_tester.permutation_id)
debug = True
