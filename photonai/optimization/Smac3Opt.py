...
class SMACOptimizer(PhotonBaseOptimizer):
    ...
    def __init__(self, cutoff_time: float=float('inf'), run_obj: str="quality", runcount_limit: float=float("inf"), tuner_timeout: float=float("inf"), \
        wallclock_limit: float=float("inf")):           # run_obj = {quality, runtime}
        self.optimizer = None
        self.scenario = None
