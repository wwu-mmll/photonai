from DemoFiles.MultiTask.helpers import get_data, run_analysis
import numpy as np
import pandas
...
if __name__ == '__main__':
    ...
    for roiName in ROI_names:
        ...
        output_node_dict = {'name': roiName, 'target_dimension': 1,
                            'activation': 'linear',
                            'loss': 'mse', 'loss_weight': 1}
        outputs_dict_list.append(output_node_dict)

    results = mp.Pool(1).map(run_analysis, data_dict_list)
