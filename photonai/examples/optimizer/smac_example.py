...
my_pipe = Hyperpipe(
    ...
    optimizer_params={"wallclock_limit": 60.0 * 2},
...
my_pipe += PipelineElement(
    "PCA", hyperparameters={"n_components": IntegerRange(5, 10)}, test_disabled=True
)
...
switch += PipelineElement(
    "SVR",
    hyperparameters={
        "C": FloatRange(0, 10, range_type="linspace"),
...
switch += PipelineElement(
    "RandomForestRegressor", hyperparameters={"n_estimators": Categorical([10, 20])}
)
