...
class PhotonBaseConstraintTest(unittest.TestCase):
    ...
    def test_shall_continue(self):
        ...
        self.assertEqual(
            self.constraint_object.shall_continue(self.dummy_config_item), True
        )
    ...
    def test_copy_me(self):
        ...
        self.assertDictEqual(
            new_constraint_object.__dict__, self.constraint_object.__dict__
        )
...
class MinimumPerformanceTest(PhotonBaseConstraintTest):
    def setUp(self):
        ...
        self.constraint_object = MinimumPerformance(
            strategy="first", metric="f1_score", threshold=0
        )
    ...
    def test_shall_continue(self):
        ...
        self.constraint_object.threshold = 0
        self.assertEqual(
            self.constraint_object.shall_continue(self.dummy_config_item), False
        )
        ...
        self.constraint_object.strategy = "first"
        self.assertEqual(
            self.constraint_object.shall_continue(self.dummy_linear_config_item), False
        )
        self.constraint_object.strategy = "mean"
        self.assertEqual(
            self.constraint_object.shall_continue(self.dummy_linear_config_item), True
        )
        self.constraint_object.strategy = "all"
        self.assertEqual(
            self.constraint_object.shall_continue(self.dummy_linear_config_item), False
...
class DummyPerformanceConstraints(PhotonBaseConstraintTest):
    def setUp(self):
        ...
        self.constraint_object = DummyPerformance(
            strategy="first", metric="mean_squared_error", margin=0.1
        )
        self.constraint_object.set_dummy_performance(
            self.dummy_config_item.inner_folds[0]
        )
...
class BestPerformanceTest(PhotonBaseConstraintTest):
    def setUp(self):
        ...
        self.constraint_object = BestPerformance(
            strategy="mean", metric="mean_squared_error"
        )
