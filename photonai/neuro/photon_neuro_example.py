...
my_pipe += PipelineElement.create('SmoothImages', {'fwhr': [[8, 8, 8], [12, 12, 12]]})
...
# resImg = ResampleImages(voxel_size=[5, 5, 5], output_img=True).transform(dataset_files)
# smImg = SmoothImages(fwhr=[6, 6, 6], output_img=True).transform(resImg)
#
