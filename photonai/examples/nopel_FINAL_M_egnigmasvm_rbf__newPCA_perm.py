...
# Load data
df = pd.read_excel('/spm-data/Scratch/photon_wizard/nopel/FINAL_svm5fold_M/BMIGr_M.xlsx')
...
def create_hyperpipe():
    ...
    output_settings = OutputSettings(mongodb_connect_url="mongodb://trap-umbriel:27017/photon_results",
                                     ...
                                     project_folder="/spm-data/Scratch/photon_wizard/nopel/FINAL_svm5fold_M",
                                     user_id="nopel")

    # Define hyperpipe
    hyperpipe = Hyperpipe('enigmasvmnewpca_final_m',
