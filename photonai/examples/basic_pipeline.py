...
mongo_settings = PersistOptions(local_file="/home/rleenings/Dokumente/Betreuung Studenten/test_item.p")
...
my_pipe += PipelineElement('PCA', {'n_components': [5, 10, None]}, test_disabled=True)
